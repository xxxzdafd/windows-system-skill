...
AI Agent 的 Windows 系统管理技能包。纯 PowerShell，省 token，全覆盖，拿来即用。
...
```bash
# One-line install via agent CLI
opencode skill install xxxzdafd/windows-system-skill
...
Tell your agent: "电脑卡了" / "my computer is slow" — it knows which reference to open.
